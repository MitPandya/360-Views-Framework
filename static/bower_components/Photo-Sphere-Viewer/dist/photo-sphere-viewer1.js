  ...
  this.config.forEach(function(button) {
    if (typeof button == 'object') {
      ...
      switch (button) {
        ...
        case PSVNavBarPanelsButton.id:
          this.items.push(new PSVNavBarPanelsButton(this));
          break;
...
/**
 * Navigation bar panel button class
 * @param {PSVNavBar} navbar
 * @constructor
 */
function PSVNavBarPanelsButton(navbar) {
  PSVNavBarButton.call(this, navbar);
...
PSVNavBarPanelsButton.prototype = Object.create(PSVNavBarButton.prototype);
PSVNavBarPanelsButton.prototype.constructor = PSVNavBarPanelsButton;

PSVNavBarPanelsButton.id = 'panels';
PSVNavBarPanelsButton.className = 'psv-button psv-button--hover-scale psv-markers-button';
 ...
 * Creates the button
 */
PSVNavBarPanelsButton.prototype.create = function() {
  PSVNavBarButton.prototype.create.call(this);

  this.container.title = this.psv.config.lang.panels;
 ...
 * Destroys the button
 */
PSVNavBarPanelsButton.prototype.destroy = function() {
  this.psv.off('open-panel', this);
  this.psv.off('close-panel', this);
 ...
 * @private
 */
PSVNavBarPanelsButton.prototype.handleEvent = function(e) {
  switch (e.type) {
    // @formatter:off
    case 'open-panel': this._onPanelOpened(); break;
    case 'close-panel': this._onPanelClosed(); break;
 ...
 * Close side panel
 */
PSVNavBarPanelsButton.prototype.hideMarkersList = function() {
  if (this.prop.panelOpened) {
    this.psv.panel.hidePanel();
  }
};
 ...
 * @private
 */
PSVNavBarPanelsButton.prototype._onPanelOpened = function() {
  if (this.prop.panelOpening) {
    this.prop.panelOpening = false;
    this.prop.panelOpened = true;
  }
 ...
 * @private
 */
PSVNavBarPanelsButton.prototype._onPanelClosed = function() {
  this.prop.panelOpened = false;
  this.prop.panelOpening = false;
...
PhotoSphereViewer.ICONS['layers.svg'] = '<svg fill="#000000" height="18" viewBox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"> <path d="M0 0h24v24H0z" fill="none"/><path d="M11.99 18.54l-7.37-5.73L3 14.07l9 7 9-7-1.63-1.27-7.38 5.74zM12 16l7.36-5.73L21 9l-9-7-9 7 1.63 1.27L12 16z"/></svg>';
